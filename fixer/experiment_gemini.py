...
maven_only_results_json_basepath = "../maven_only_results"

json_data = {} #[command] = {owner, repo, yaml_filename, job, all_unused, maven_unused, fix_suggestion, old_commands}

projects="../project-based-results.csv" #owner,repo,all_unused,maven_unused
jobs="../job-based-results.csv" #owner;repo;yaml_filename;job;all_unused;maven_unused
fixer_result="../filter/results.csv" #owner;repo;yaml_filename;job;all_unused;maven_unused;fix_suggestion;old_commands
